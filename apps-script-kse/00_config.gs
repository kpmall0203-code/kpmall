...
var CONFIG_DESC = {
  ...
  KSE_등록순서: 'KSE에 보낼 차례. [시트 아래부터](기본) 면 맨 아랫줄을 먼저 접수한다 — 급한 건이 마지막에 접수돼 접수 목록·송장을 뽑을 때 앞 장에 온다. KSE 목록이 오래된 접수부터 나오면 [시트 위부터] 로 바꾼다',
