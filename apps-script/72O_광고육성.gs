...
function adGrowRecommend_(sku, priceJpy, marginPct, multiple) {
  ...
  // ① 마진율 — 한 곳(72AA)에 묻는다: 기준값 시트 > 원가 계산 > 바깥 마진율 시트 > 기본값
  ...
  try {
    ...
    m = Math.round((Number(basis['기본 마진율']) || MARGIN_DEFAULT_PCT / 100) * 1000) / 10;
