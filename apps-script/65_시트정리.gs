...
function tabModes_() {
  return [
    ...
    { key: 'ads', name: '광고 (기준 · 재배분 · 캠페인 · 검색어)',
      tabs: [SHEET_DASH, SHEET_ADWATCH, SHEET_ADGROW, SHEET_POLICY, SHEET_INBOX, SHEET_ADRANK, SHEET_JOB, SHEET_SPENDDAY, SHEET_ADBASIS, SHEET_REALLOC, SHEET_ADPLAN, SHEET_ADPLAN_GROW, SHEET_ADSTRUCT, SHEET_ADGRP,
