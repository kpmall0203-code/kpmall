  ...
  ui.createMenu('가격관리')
    ...
    .addSubMenu(ui.createMenu('📣 광고')
      ...
      .addSubMenu(ui.createMenu('🌱 트랙 B — 새 상품 키우기')
        ...
        .addItem('④ 자동 겨냥 좁히기 (자동 캠페인 · 상품 겨냥 끔)', 'narrowAdGrowTargets')
        .addItem('⑤ 기준키워드 올리기 (수동 캠페인)', 'applyAdGrowKeyword')
        .addSeparator()
    ...
    .addSubMenu(ui.createMenu('⚙ 설정')
      ...
      .addSubMenu(ui.createMenu('🔑 연결 · 자격증명')
        ...
        .addSeparator()
        .addItem('라쿠텐 RMS 자격증명 설정', 'setupRmsCredentials')
        .addItem('라쿠텐 연결 진단', 'diagnoseRmsAuth')
        .addSeparator()
