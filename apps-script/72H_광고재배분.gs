...
var ADBASIS_DEFAULTS = [
  ...
  ['확대 · 최대 동시 시험 수', '', '⚠ 비우면 시험을 시작하지 않습니다. 한 번에 몇 개까지 돌릴까'],
  ['확대 · 시험 주간 지출한도(JPY)', '', '⚠ 비우면 시험을 시작하지 않습니다. 시험분이 7일에 더 쓸 수 있는 돈'],
  ['확대 · 시험 손실한도(JPY)', '', '⚠ 비우면 시험을 시작하지 않습니다. 시험 전체가 잃어도 되는 한도 — 넘으면 즉시 복원'],
  ['확대 · 최대 유효입찰(JPY)', '', '⚠ 비우면 시험을 시작하지 않습니다. 어떤 계산이 나와도 이 값을 넘겨 부르지 않는다'],
  ['확대 · 승격 일예산 상한(JPY)', '',
   '⚠ 비우면 승격(몰아넣기 그룹에서 꺼내기)을 하지 않습니다. 새로 만드는 가격선 캠페인들의 ' +
   '하루 예산 합계 상한입니다. 넘는 만큼은 다음 차례로 미룹니다'],
  ['확대 · 승격 첫 배수', 1.5,
